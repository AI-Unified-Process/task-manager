package ch.martinelli.demo.aiup.core.domain;

import ch.martinelli.demo.aiup.db.tables.User;
import ch.martinelli.demo.aiup.db.tables.records.UserRecord;
import ch.martinelli.demo.aiup.db.tables.records.UserRoleRecord;
